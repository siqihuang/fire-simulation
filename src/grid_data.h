...
// Stacks are indexed with j and incrase with y
// Rows are indexed with k and increase with z
//
...
public:
   ...
   // value from this grid. default_v is returned for points
   ...
   virtual bool isValidIndex(const int index, const int axis) const;
